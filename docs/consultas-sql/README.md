...
| `correcao-divergencia-estoque-delivery-2026-04-09.sql` | Registro da correção **Estoque → Delivery**: faltantes em `DIVERGENCE` movidos para o Delivery e remessa `DELIVERED` (não reexecutar sem revisar UUIDs) |
