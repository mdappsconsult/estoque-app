...
export const ROUTE_PERMISSIONS: Record<string, string[]> = {
  ...
  '/cadastros/industria': ['ADMIN_MASTER', 'MANAGER', 'OPERATOR_WAREHOUSE', 'OPERATOR_WAREHOUSE_DRIVER'],
...
export const ROUTE_UI_META: { path: string; label: string; section: string }[] = [
  ...
  { path: '/cadastros/industria', label: 'Cadastro — indústria (hoje p/ lojas)', section: 'Cadastros' },
